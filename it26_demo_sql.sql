...
--
-- Host: 127.0.0.1
-- Generation Time: May 05, 2025 at 08:44 AM
...
(1234, 'rynier', 'achas', 'rynier08@gmail.com', 3),
(1235, 'cade', 'alim', 'cade01@gmail.com', 2);
...
(8, 123, '2025-02-08', 1234),
(30, 125, '2025-05-01', 1235),
(40, 124, '2025-02-20', 1235);
...
--
ALTER TABLE `customers`
  MODIFY `customer_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1237;
